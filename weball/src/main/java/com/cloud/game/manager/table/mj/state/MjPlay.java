...
public class MjPlay extends AbstractTableHandle {
    ...
    private boolean doDrawTile(Table table) {
        ...
        logger.info("麻将进入摸牌状态, tableId: {}, seat: {}, tileDrawn: {}, discardAfterClaim: {}",
                table.getTableId(), table.getOp().getCurrOpSeat(),
                mjTable.getMjContext().isTileDrawn(), mjTable.getMjContext().isDiscardAfterClaim());
