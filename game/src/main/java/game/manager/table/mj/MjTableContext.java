...
public class MjTableContext {
	...
	public boolean isDiscardAfterClaim() { return discardAfterClaim; }
	...
	public static final class DiscardRecord {
		...
		DiscardRecord(int seat, int tileId) { this.seat = seat; this.tileId = tileId; }
	...
	public void setAiLevel(int aiLevel) {
		this.aiLevel = Math.max(game.manager.table.ddz.ai.AiVision.AI_DUMB,
				Math.min(game.manager.table.ddz.ai.AiVision.AI_MASTER, aiLevel));
	}
}
