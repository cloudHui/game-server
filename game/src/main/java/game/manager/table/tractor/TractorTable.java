...
import game.manager.table.tractor.TractorBidService;
import game.manager.table.tractor.TractorCardPool;
import game.manager.table.tractor.TractorPlayService;
...
public class TractorTable extends Table {
	...
	@Override
	public int getGameType() { return 4; }
	...
	public TractorCardPool getCardPool() { return cardPool; }
	public TractorTableContext getTractor() { return tractor; }
}
