...
public class TractorTableContext {
	...
	public void setTrumpSuit(int trumpSuit) { this.trumpSuit = trumpSuit; }

	public int getBankerSeat() { return bankerSeat; }
	public void setBankerSeat(int bankerSeat) { this.bankerSeat = bankerSeat; }
	...
	public void addDefenderScore(int s) { defenderScore += s; }

	public List<Integer> getRevealedBottom() { return Collections.unmodifiableList(revealedBottom); }
	public void setRevealedBottom(List<Integer> ids) {
		revealedBottom.clear();
		if (ids != null) revealedBottom.addAll(ids);
	}

	public List<Integer> getBuriedCards() { return Collections.unmodifiableList(buriedCards); }
	public void setBuriedCards(List<Integer> ids) {
		buriedCards.clear();
		if (ids != null) buriedCards.addAll(ids);
	}

	public int getBidStrength() { return bidStrength; }
	public void setBidStrength(int bidStrength) { this.bidStrength = bidStrength; }
	public int getBidSuit() { return bidSuit; }
	public void setBidSuit(int bidSuit) { this.bidSuit = bidSuit; }
	public int getBidSeat() { return bidSeat; }
	public void setBidSeat(int bidSeat) { this.bidSeat = bidSeat; }
	public int getBidPasses() { return bidPasses; }
	public void incBidPasses() { bidPasses++; }
	public void resetBidPasses() { bidPasses = 0; }

	public boolean isDealing() { return dealing; }
	public void setDealing(boolean dealing) { this.dealing = dealing; }
	public int getDealNextSeat() { return dealNextSeat; }
	public void setDealNextSeat(int dealNextSeat) { this.dealNextSeat = dealNextSeat; }
	public int getDealPlayerCount() { return dealPlayerCount; }
	public void setDealPlayerCount(int dealPlayerCount) { this.dealPlayerCount = dealPlayerCount; }
	public long getLastDealTime() { return lastDealTime; }
	public void setLastDealTime(long lastDealTime) { this.lastDealTime = lastDealTime; }

	public int getBottomHolderSeat() { return bottomHolderSeat; }
	public void setBottomHolderSeat(int bottomHolderSeat) { this.bottomHolderSeat = bottomHolderSeat; }

	public TractorRules.Combo getLeadCombo() { return leadCombo; }
	public void setLeadCombo(TractorRules.Combo leadCombo) { this.leadCombo = leadCombo; }

	public List<List<Card>> getTrickPlays() { return trickPlays; }
	public List<Integer> getTrickSeats() { return trickSeats; }
	public int getTrickLeader() { return trickLeader; }
	public void setTrickLeader(int trickLeader) { this.trickLeader = trickLeader; }
	...
	public void incTricksDone() { tricksDone++; }
