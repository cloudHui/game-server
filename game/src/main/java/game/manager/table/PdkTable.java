...
import game.manager.table.pdk.PdkCardPool;
import game.manager.table.pdk.PdkPlayService;
...
public class PdkTable extends Table {
	...
	@Override
	public int getGameType() { return 3; }
	...
	public PdkCardPool getCardPool() { return cardPool; }
	public Banner getBanner() { return banner; }
	public PdkTableContext getPdk() { return pdk; }

	/** CARD 通知阶段供状态机读取上一手 */
	public DdzHand getLastHand() { return pdk.getLastHand(); }
	...
	public boolean canCurrentPlayerPass() {
		...
		return user != null && !game.manager.table.pdk.PdkRules.canBeat(user.getCards(), pdk.getLastHand());
	}
}
