...
public class PhotoController {
    private final PhotoService photos; private final UserService users; private final SessionResolver sessions; private final PhotoProperties properties;
    public PhotoController(PhotoService photos,UserService users,SessionResolver sessions,PhotoProperties properties){this.photos=photos;this.users=users;this.sessions=sessions;this.properties=properties;}
