...
(function (w) {
  ...
  function collectUsed(game) {
    var used = {};
    game.targets.forEach(function (t) { used[t.value] = true; });
    game.queue.forEach(function (t) { used[t.value] = true; });
    return used;
  }
  ...
  function createTarget(game) {
    ...
    do {
      ...
      tries++;
    } while (tries < 40 && game.targets.some(function (t) { return Math.abs(t.x - x) < minDist; }));
