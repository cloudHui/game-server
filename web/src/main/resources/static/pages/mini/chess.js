(function () {
    ...
    document.getElementById('backLink').href = appUrl('/pages/home/room.html');
    ...
    var view = ChessView.create(canvas, function(){return board;}, function(){return selected;}, NAMES);
    var aiWorker = null;
    var aiJob = 0;
    var aiStartedAt = 0;
    ...
    function isRed(p) { return ChessRules.isRed(p); }
    function inBoard(r,c){ return ChessRules.inBoard(r,c); }
    ...
    function startLocal(){
        closeSock(); stopAiWorker(); mode='ai'; iAmRed=true; aiLevel=parseInt(document.getElementById('difficulty').value,10)||2; initBoard(); restartAiWorker(); draw();
    ...
    function resignGame(){
        ...
        finished=true; stopAiWorker(); document.getElementById('resignBtn').disabled=true;
        setStatus('你认输，电脑获胜');
    }
    function resetToMenu(){
        closeSock(); stopAiWorker(); mode=null; initBoard(); draw();
        setStatus('请选择模式');
        document.getElementById('resignBtn').disabled=true;
        document.getElementById('cancelBtn').style.display='none';
