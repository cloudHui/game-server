 ...
 * 列出目录内容，并附带 size。
 */
@Process(value = "list_directory_with_sizes", description = "列出目录及大小。", required = {"path"},
    optional = {"sortBy", "offset", "limit", "maxOutputChars"})
public class DirectorySizes implements CommandHandler {
