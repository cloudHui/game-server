 ...
 * 递归目录树。
 */
@Process(value = "directory_tree", description = "递归列出目录树。", required = {"path"},
    optional = {"excludePatterns", "maxDepth", "maxNodes", "maxOutputChars"})
public class Tree implements CommandHandler {
