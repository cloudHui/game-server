 ...
 * @date 2026/05/20
 */
@Process(value = "git_log", description = "按日期区间列出提交。", required = {"since"},
    optional = {"until", "author", "noMerges", "maxCount", "maxOutputChars"})
public class LogHistory implements CommandHandler {
