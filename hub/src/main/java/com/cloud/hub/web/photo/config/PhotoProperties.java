...
public class PhotoProperties {
    ...
    public PhotoProperties(DataPathResolver paths) {
        this.paths = paths;
    }
    ...
    public void setDataDir(String v) {
        dataDir = v;
    }
    ...
    public void setArchiveDir(String v) {
        archiveDir = v;
    }
    ...
    public void setThumbnailDir(String v) {
        thumbnailDir = v;
    }
    ...
    public void setCacheDir(String v) {
        cacheDir = v;
    }
    ...
    public void setStagingDir(String v) {
        stagingDir = v;
    }
    ...
    public void setDefaultZone(String v) {
        defaultZone = v;
    }
    ...
    public void setCacheMaxFiles(int v) {
        cacheMaxFiles = v;
    }
    ...
    public void setThumbnailMaxWidth(int v) {
        thumbnailMaxWidth = v;
    }
    ...
    public void setThumbnailMaxHeight(int v) {
        thumbnailMaxHeight = v;
    }
    ...
    public void setMaxFilesPerRequest(int v) {
        maxFilesPerRequest = v;
    }
    ...
    public void setArchiveMaxBytes(long v) {
        archiveMaxBytes = v;
    }
    ...
    public void setMaxPixels(long v) {
        maxPixels = v;
    }

    @PostConstruct
    public void normalizePaths() {
        dataDir = paths.resolve(dataDir).toString();
        archiveDir = paths.resolve(archiveDir).toString();
        thumbnailDir = paths.resolve(thumbnailDir).toString();
        cacheDir = paths.resolve(cacheDir).toString();
