package com.cloud.hub.web.photo.model;
...
public class PhotoRecord {
    ...
    public Map<String, Object> publicView() {
        ...
        m.put("ownerUsername", ownerUsername);
        m.put("capturedAt", capturedAt);
        m.put("capturedAtSource", capturedAtSource);
        m.put("uploadedAt", uploadedAt);
        m.put("mediaType", mediaType);
        m.put("width", width);
        m.put("height", height);
        m.put("originalSize", originalSize);
        m.put("thumbnailUrl", "/api/photos/" + id + "/thumbnail");
        m.put("originalUrl", "/api/photos/" + id + "/original");
        return m;
    }
}
